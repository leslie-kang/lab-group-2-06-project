...
# Proposal 3
We retrieved this data from who.int under the Global School-Based Student Health
Survey (GSHS). The authors of this dataset collected the data through written
surveys handed out in schools throughout Egypt. The survey contains dozens of
questions about the lifestyle of these students such as what they eat, their
history of substance use, their hygiene practices and their levels of physical 
activity. 

Some variables that would be interesting to look at are `Q29` and its
relationship to `Q32` and `Q33`. `Q29` encodes the students response to how many
days they had smoked in the past month. `Q32` encodes the students response to
how many times people had smoked in their presence in the past week. `Q33`
encodes the students response to a question about their parents' history of
tobacco use. We hypothesize that students with people/parents smoking in their
presence are likely to report having smoked more than students that do not have
...
peers/parents who smoke and $p_n$ is the number of days smoked in the past month
by students who do not encounter anyone that smokes. 

```{r uploading_dat}
www = "https://www.who.int/ncds/surveillance/gshs/EGH2011_gshs_public_use.dat"
